...
Route::get('/jobPosition/prueba', [App\Http\Controllers\JobPositionController::class, 'getPostulantesXPuestosXCategoria'])->name('jobPosition.getPostulantesXPuestosXCategoria');
