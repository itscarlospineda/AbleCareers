                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('job-positions.destroy',$jobPosition->id) }}" method="POST">
                                                    <a class="btn btn-sm btn-primary " href="{{ route('job-positions.show',$jobPosition->id) }}"><i class="fa fa-fw fa-eye"></i> {{ __('Show') }}</a>
                                                    <a class="btn btn-sm btn-success" href="{{ route('job-positions.edit',$jobPosition->id) }}"><i class="fa fa-fw fa-edit"></i> {{ __('Edit') }}</a>
                                                    @csrf
                                                    @method('DELETE')
