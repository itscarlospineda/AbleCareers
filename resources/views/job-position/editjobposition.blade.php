        ...
        <div class="">
            <div class="col-md-12">
                ...
                <div class="card card-default">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('jobPosition.update_or_destroy', $jobPosition->id) }}"
                            ...
                            <div class="mb-3 form-check">
                                <input type="checkbox" class="form-check-input" id="is_active" name="active"
                                    {{ $jobPosition->is_active === 'ACTIVE' ? 'checked' : 'INACTIVO' }}>
