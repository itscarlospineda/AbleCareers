...
<body>
    ...
    <div class="container-fluid">
        ...
        <nav
            class="navbar navbar-expand-lg navbar-light mainbar d-flex justify-content-between align-items-center fixed-top">
            <div class="container-fluid">
                <a class="navbar-brand d-flex align-items-center ms-3" href="{{ route('landing') }}">
                    <img src="vendor\adminlte\dist\img\AbleCareersLogo.png" alt="idea" srcset="" width="50px"
                        height="50px">
                    ...
                    <div class="d-flex me-2 justify-content-center">
                        <ul class="nav mb-0">
                            <li class="nav-item"><a href="{{ route('login') }}"
                                    class="nav-link fw-bold authBtn me-2">Login</a></li>
                            <li class="nav-item"><a href="{{ route('register') }}"
                                    class="nav-link fw-bold authBtn">Register</a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="container-fluid mt-5 pt-5 hero black">
        <div class="row mt-4 pt-4">
            <div class="col-md-6">
                <div class="mx-5 my-2">
                    <p class="display-5">Bienvenido a <span class="display-4 fw-bold">AbleCareers</span></p>
                    <hr>
                ...
                <div class="col-md-4 d-flex flex-column">
                    @foreach ($jobLatest as $latest)
                        <div class="card border-dark mb-4 flex-grow-1">
                            <img src="vendor\adminlte\dist\img\think-nobg.png" alt=""
                                class="card-img-top img-dark">
                            <div class="card-body">
                                <h5 class="card-title">{{ $latest->name }}</h5>
                                <p class="card-text lightgreen">{{ $latest->company->comp_name }}</p>
                                <p class="card-text">
                                    {{ \Illuminate\Support\Str::limit($latest->description, 90, $end = '...') }}</p>
                            </div>
                        </div>
                    @endforeach
                </div>
                        ...
                        @if ($key > 0)
                            <div class="card border-dark mb-4 flex-grow-1">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">
                                        {{ \Illuminate\Support\Str::limit($jobPos->description, 90, $end = '...') }}</p>
                                </div>
                            </div>
                        @endif
                    @endforeach
        ...
        <div class="row">
            <div class="col-md-4">
                <p class="mx-2">Proyecto elaborado por los estudiantes universitarios de la clase de Desarrollo de
                    Aplicaciones en Internet, en un espacio de dos meses aproximademente, yendo desde la fase de
                    planeación
