...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Roboto:wght@100..900&family=Poppins:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&display=swap"
        rel="stylesheet">
...
<body>
    ...
    <div class="container-fluid">
        <nav class="navbar navigation fixed-top d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex align-items-center">
                <ul class="nav me-5">
                    <li class="nav-item"><a href="{{ route('login') }}" class="nav-link text-dark fw-bold"
                            style="background-color: white; border-radius:10px;">Login</a></li>
        ...
        <div class="row oval">
            <center>
                <p class="h5 text-white">Encuentra ofertas de empleo y conéctate en el mejor lugar para expandir tu
                    futuro.</p>
            </center>
        </div>
                    ...
                    <div class="col-lg">
                        <div class="card h-100">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">
                                    {{ \Illuminate\Support\Str::limit($jobPos->description, 65, $end = '...') }}</p>
                            </div>
                        </div>
                    </div>
                </div>
