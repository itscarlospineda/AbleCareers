...
@section('content')
    <div class="col-md-12 mt-2" style="padding-top: 20px; padding-left: 30px;">
        <div class="col">
            <p class="h2">Solicitudes de Usuarios (Aprobados)</p>
            <p class="h5">Aquí se muestran las solicitudes en estado "Aprobado".</p>
        </div>
        ...
        <!-- Aquí va el código para mostrar las solicitudes en estado "Aprobado" -->
