...
@section('content')
    ...
    <form action="{{ route('resume.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="education_two" name="education_two" placeholder="Ingrese lugar de educación">
        </div>
        <div class="form-group">
            <label for="education_two_years">Título y Años (####-####) de Educación #2:</label>
            <input type="text" class="form-control" id="education_two_years" name="education_two_years" placeholder="Ingrese título y tiempo de estudio">
        </div>
        <div class="form-group">
            <label for="education_two_pos">Descripción de Educación #2:</label>
            <textarea style="height: 70px; resize:none" name="education_two_pos" class="form-control" placeholder="Ingrese una breve descripción"></textarea>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="extra" name="extra" placeholder="Ingrese información adicional">
        </div>
        <div class="form-group">
            <label for="reference">Referencia Personal #1:</label>
            <input type="text" class="form-control" id="reference" name="reference" placeholder="Ingrese nombre y apellido de referencia">
        </div>
        <div class="form-group">
            <label for="reference_num">Número de Referencia (####-####) #1:</label>
            <input type="text" class="form-control" id="reference_num" name="reference_num" placeholder="Ingrese número de celular de referencia">
        </div>
        <div class="form-group">
            <label for="reference_two">Referencia Personal #2:</label>
            <input type="text" class="form-control" id="reference_two" name="reference_two" placeholder="Ingrese nombre y apellido de referencia">
        </div>
        <div class="form-group">
            <label for="reference_two_num">Número de Referencia (####-####) #2:</label>
            <input type="text" class="form-control" id="reference_two_num" name="reference_two_num" placeholder="Ingrese número de celular de referencia">
        </div>
