                        ...
                        <div class="container mt-4">
                            ...
                            <div class="mx-1 mt-2">
                                <ul class="nav flex-column">
                                    ...
                                    <li class="nav-link">
                                        <a href="{{ route('jobPosition.create') }}" class="nav-link font">
                                    ...
                                    <li class="nav-link">
                                        <a href="{{ route('jobPosition.index') }}" class="nav-link font">
                                    ...
                                    <li class="nav-link">
                                        <a href="{{ route('resume.index') }}" class="nav-link font">   {{-- RUTA DE PORSULANTES: VERIFICAR --}}
