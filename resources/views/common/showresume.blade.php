				    ...
				    <div class="col">
					    <div class="row p-4 justify-content-center justify-content-md-between">
						    <div class="primary-info col-auto">
							    <h1 class="name mt-0 mb-1 text-white text-uppercase text-uppercase">{{$resume->user->name}}&nbsp;<span style="display: block;">{{$resume->user->lastName}}</span></h1>
							    <div class="title my-3"></div>
						    ...
						    <div class="secondary-info col-md-6">
								<center>
