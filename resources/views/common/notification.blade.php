                    ...
                    <ul class="list-group">
                        @foreach ($notificaciones as $notificacion)
                            <li class="list-group-item">
                                <div class="d-flex justify-content-between align-items-center" onclick="toggleComment(this)"
                                    style="cursor: pointer;">
                                    <div class="d-flex align-items-center">
                                        <div>
                                            <p class="mb-0"
                                                style="font-size: 18px; color: midnightblue; font-weight: bold;">
                                                {{ $notificacion->job_position_name }}</p>
                                            <p class="text-muted mb-0"><i class="far fa-clock"></i>
                                                {{ $notificacion->created_at }}</p>
